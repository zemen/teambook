/*
 * This file [basic/queue.h] is part of the “libtamias” library
...
namespace tamias
{
  template <typename Type>
    class Queue : private hidden::AbstractData
    {
      public:
        Queue();
...
template <typename Type>
  Type tamias::Queue<Type>::pop()
  {
    ...
    mStart++, mSize--;
    if (mStart >= 160000000 && mStart >= mSize) // The magic force of amortized analysis starts here.
    {
      for (sizetype i = 0; i < mSize; i++)
      {
